...
public class ProfileMapper {
    ...
    public ProfileDTO toDTO(UserProfile profile) {
        ...
        dto.setPinCode(String.valueOf(profile.getPinCode()));
        ...
        dto.setWeight(String.valueOf(profile.getWeight()));
    ...
    public UserProfile toEntity(ProfileDTO dto) {
        ...
        profile.setPinCode(Integer.valueOf(dto.getPinCode()));
        ...
        profile.setHeight(Integer.valueOf(dto.getHeight()));
        profile.setBloodGroup(dto.getBloodGroup());
        profile.setWeight(Integer.valueOf(dto.getWeight()));
